"""
Real-time feature store service.
- Redis sorted sets store user behavior sequences (score = timestamp).
- Sliding windows compute real-time features over 1h/24h/7d ranges.
- Offline and online profile tags can be merged.
- RFM-style scores are derived from purchase behavior.
"""
